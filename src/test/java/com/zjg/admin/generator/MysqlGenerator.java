package com.zjg.admin.generator;
...
public class MysqlGenerator {
	...
	public static void main(String[] args) {
		...
		String outputDir = "/Users/zhaojianguo/Documents/E/generator/mysql-gennerator";
...
//		strategy.setTablePrefix(new String[] { "bmd_", "mp_" });// 此处可以修改为您的表前缀
		strategy.setNaming(NamingStrategy.underline_to_camel);// 表名生成策略
		 strategy.setInclude(new String[] { "sys_dict_item" }); // 需要生成的表
		...
		// 自定义 controller 父类
		strategy.setSuperControllerClass("com.zjg.admin.commons.base.BaseController");
		...
		pc.setParent("com.zjg.admin"); // 自定义包路径
